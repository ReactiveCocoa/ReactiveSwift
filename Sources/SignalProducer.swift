...
extension SignalProducer {
	...
	public func debounce(_ interval: TimeInterval, on scheduler: DateScheduler, discardsWhenCompleted: Bool = true) -> SignalProducer<Value, Error> {
		return core.flatMapEvent(Signal.Event.debounce(interval, on: scheduler, discardsWhenCompleted: discardsWhenCompleted))
	}
